...
**Primary Compute:** Intel N100 Mini PC (8 GB RAM + 256 GB SSD) using built-in Intel UHD iGPU (OpenVINO FP16)  
...
| :--- | :--- | :--- |
| **Intel N100 Mini PC**<br>*(e.g., GMKtec G3 / Beelink S12 Pro)* | **Host Edge Server**: Quad-Core CPU (up to 3.4GHz, 6W TDP) with Intel UHD QuickSync hardware video decoding (VA-API H.264/H.265). Runs FastAPI backend, SQLite DB, DVR engine, and WebRTC streaming. | $199.00 |
| **RAM: 8 GB DDR4 / DDR5**<br>*(3200MHz / 4800MHz SODIMM)* | **System Memory**: Buffers incoming camera RTSP streams, maintains in-memory JPEG ring buffers, and caches SQLite event logs. System uses ~2.2GB–3.0GB active RAM, leaving ~5GB free. | Included<br>*(with PC)* |
| **Storage: 256 GB – 512 GB NVMe SSD**<br>*(Crucial P3 Plus / Kingston NV2)* | **System Drive & 24/7 DVR**: Houses OS, AI models, SQLite database, incident video clip archives, and rolling continuous DVR recording segments. | Included<br>*(with PC)* |
...
| **Total (Base Necessary System)** | **Complete Standalone Edge AI Surveillance Hub** | **~$460.00 AUD** |
...
| Item | Use / Need | Cost (AUD) |
| :--- | :--- | :--- |
| **RAM Upgrade: 16 GB DDR4 / DDR5**<br>*(16GB SODIMM or 16GB PC Variant)* | **Multi-Camera Expansion & Heavy Docker Load**: Recommended when scaling beyond 4 cameras, buffering multiple concurrent 4K high-bitrate streams, or running heavy parallel microservices. | $45.00 |
